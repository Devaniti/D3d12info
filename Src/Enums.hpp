...
ENUM_BEGIN(DXGI_STATUS)
    ENUM_ITEM(DXGI_STATUS_OCCLUDED)
    ENUM_ITEM(DXGI_STATUS_CLIPPED)
    ENUM_ITEM(DXGI_STATUS_NO_REDIRECTION)
    ENUM_ITEM(DXGI_STATUS_NO_DESKTOP_ACCESS)
    ENUM_ITEM(DXGI_STATUS_GRAPHICS_VIDPN_SOURCE_IN_USE)
    ENUM_ITEM(DXGI_STATUS_MODE_CHANGED)
    ENUM_ITEM(DXGI_STATUS_MODE_CHANGE_IN_PROGRESS)
    ENUM_ITEM(DXGI_ERROR_INVALID_CALL)
    ENUM_ITEM(DXGI_ERROR_NOT_FOUND)
    ENUM_ITEM(DXGI_ERROR_MORE_DATA)
    ENUM_ITEM(DXGI_ERROR_UNSUPPORTED)
    ENUM_ITEM(DXGI_ERROR_DEVICE_REMOVED)
    ENUM_ITEM(DXGI_ERROR_DEVICE_HUNG)
    ENUM_ITEM(DXGI_ERROR_DEVICE_RESET)
    ENUM_ITEM(DXGI_ERROR_WAS_STILL_DRAWING)
    ENUM_ITEM(DXGI_ERROR_FRAME_STATISTICS_DISJOINT)
    ENUM_ITEM(DXGI_ERROR_GRAPHICS_VIDPN_SOURCE_IN_USE)
    ENUM_ITEM(DXGI_ERROR_DRIVER_INTERNAL_ERROR)
    ENUM_ITEM(DXGI_ERROR_NONEXCLUSIVE)
    ENUM_ITEM(DXGI_ERROR_NOT_CURRENTLY_AVAILABLE)
    ENUM_ITEM(DXGI_ERROR_REMOTE_CLIENT_DISCONNECTED)
    ENUM_ITEM(DXGI_ERROR_REMOTE_OUTOFMEMORY)
    ENUM_ITEM(DXGI_ERROR_ACCESS_LOST)
    ENUM_ITEM(DXGI_ERROR_WAIT_TIMEOUT)
    ENUM_ITEM(DXGI_ERROR_SESSION_DISCONNECTED)
    ENUM_ITEM(DXGI_ERROR_RESTRICT_TO_OUTPUT_STALE)
    ENUM_ITEM(DXGI_ERROR_CANNOT_PROTECT_CONTENT)
    ENUM_ITEM(DXGI_ERROR_ACCESS_DENIED)
    ENUM_ITEM(DXGI_ERROR_NAME_ALREADY_EXISTS)
    ENUM_ITEM(DXGI_ERROR_SDK_COMPONENT_MISSING)
    ENUM_ITEM(DXGI_ERROR_NOT_CURRENT)
    ENUM_ITEM(DXGI_ERROR_HW_PROTECTION_OUTOFMEMORY)
    ENUM_ITEM(DXGI_ERROR_DYNAMIC_CODE_POLICY_VIOLATION)
    ENUM_ITEM(DXGI_ERROR_NON_COMPOSITED_UI)
    ENUM_ITEM(DXGI_STATUS_UNOCCLUDED)
    ENUM_ITEM(DXGI_STATUS_DDA_WAS_STILL_DRAWING)
    ENUM_ITEM(DXGI_ERROR_MODE_CHANGE_IN_PROGRESS)
    ENUM_ITEM(DXGI_STATUS_PRESENT_REQUIRED)
    ENUM_ITEM(DXGI_ERROR_CACHE_CORRUPT)
    ENUM_ITEM(DXGI_ERROR_CACHE_FULL)
    ENUM_ITEM(DXGI_ERROR_CACHE_HASH_COLLISION)
    ENUM_ITEM(DXGI_ERROR_ALREADY_EXISTS)
    ENUM_ITEM(DXGI_ERROR_MPO_UNPINNED)
    ENUM_ITEM(DXGI_ERROR_SETDISPLAYMODE_REQUIRED)
ENUM_END(DXGI_STATUS)
...
ENUM_BEGIN(D3D12_COMMAND_LIST_TYPE)
    ENUM_ITEM(D3D12_COMMAND_LIST_TYPE_DIRECT)
    ENUM_ITEM(D3D12_COMMAND_LIST_TYPE_BUNDLE)
    ENUM_ITEM(D3D12_COMMAND_LIST_TYPE_COMPUTE)
    ENUM_ITEM(D3D12_COMMAND_LIST_TYPE_COPY)
    ENUM_ITEM(D3D12_COMMAND_LIST_TYPE_VIDEO_DECODE)
    ENUM_ITEM(D3D12_COMMAND_LIST_TYPE_VIDEO_PROCESS)
    ENUM_ITEM(D3D12_COMMAND_LIST_TYPE_VIDEO_ENCODE)
    ENUM_ITEM(D3D12_COMMAND_LIST_TYPE_NONE)
ENUM_END(D3D12_COMMAND_LIST_TYPE)
...
ENUM_BEGIN(D3D_SHADER_MODEL)
    ...
    ENUM_ITEM(D3D_SHADER_MODEL_6_10)
...
ENUM_BEGIN(D3D12_RAYTRACING_TIER)
    ...
    ENUM_ITEM(D3D12_RAYTRACING_TIER_1_2)
...
ENUM_BEGIN(D3D12_FORMAT_SUPPORT2)
    ...
    ENUM_ITEM(D3D12_FORMAT_SUPPORT2_DISPLAYABLE)
...
ENUM_BEGIN(D3D12_BARRIER_LAYOUT)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_UNDEFINED)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_COMMON)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_GENERIC_READ)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_RENDER_TARGET)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_UNORDERED_ACCESS)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_DEPTH_STENCIL_WRITE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_DEPTH_STENCIL_READ)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_SHADER_RESOURCE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_COPY_SOURCE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_COPY_DEST)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_RESOLVE_SOURCE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_RESOLVE_DEST)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_SHADING_RATE_SOURCE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_VIDEO_DECODE_READ)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_VIDEO_DECODE_WRITE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_VIDEO_PROCESS_READ)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_VIDEO_PROCESS_WRITE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_VIDEO_ENCODE_READ)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_VIDEO_ENCODE_WRITE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_DIRECT_QUEUE_COMMON)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_DIRECT_QUEUE_GENERIC_READ)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_DIRECT_QUEUE_UNORDERED_ACCESS)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_DIRECT_QUEUE_SHADER_RESOURCE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_DIRECT_QUEUE_COPY_SOURCE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_DIRECT_QUEUE_COPY_DEST)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_COMPUTE_QUEUE_COMMON)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_COMPUTE_QUEUE_GENERIC_READ)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_COMPUTE_QUEUE_UNORDERED_ACCESS)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_COMPUTE_QUEUE_SHADER_RESOURCE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_COMPUTE_QUEUE_COPY_SOURCE)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_COMPUTE_QUEUE_COPY_DEST)
    ENUM_ITEM(D3D12_BARRIER_LAYOUT_DIRECT_QUEUE_GENERIC_READ_COMPUTE_QUEUE_ACCESSIBLE)
ENUM_END(D3D12_BARRIER_LAYOUT)

#ifdef USE_PREVIEW_AGILITY_SDK

ENUM_BEGIN(D3D12_PARTIAL_GRAPHICS_PROGRAMS_TIER)
    ENUM_ITEM(D3D12_PARTIAL_GRAPHICS_PROGRAMS_TIER_NOT_SUPPORTED)
    ENUM_ITEM(D3D12_PARTIAL_GRAPHICS_PROGRAMS_TIER_1_0)
ENUM_END(D3D12_PARTIAL_GRAPHICS_PROGRAMS_TIER)

ENUM_BEGIN(D3D12_DUMP_FILE_DRIVER_TIER)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_TIER_NOT_SUPPORTED)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_TIER_1)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_TIER_2)
ENUM_END(D3D12_DUMP_FILE_DRIVER_TIER)

ENUM_BEGIN(D3D12_DUMP_FILE_DRIVER_OPTIONS)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_OPTION_NO_OVERHEAD)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_OPTION_MEDIUM_OVERHEAD)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_OPTION_HIGH_OVERHEAD)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_OPTION_NO_DATA)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_OPTION_SHADER_REGISTERS)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_OPTION_RESOURCES)
    ENUM_ITEM(D3D12_DUMP_FILE_DRIVER_OPTION_EVENT_MARKERS)
ENUM_END(D3D12_DUMP_FILE_DRIVER_OPTIONS)

ENUM_BEGIN(D3D12_LINEAR_ALGEBRA_TIER)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_TIER_NOT_SUPPORTED)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_TIER_1_0)
ENUM_END(D3D12_LINEAR_ALGEBRA_TIER)

ENUM_BEGIN(D3D12_LINEAR_ALGEBRA_DATATYPE)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_SINT16)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_UINT16)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_SINT32)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_UINT32)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_FLOAT16)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_FLOAT32)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_SINT8)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_UINT8)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_FLOAT8_E4M3FN)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_DATATYPE_FLOAT8_E5M2)
ENUM_END(D3D12_LINEAR_ALGEBRA_DATATYPE)

ENUM_BEGIN(D3D12_LINEAR_ALGEBRA_MATRIX_LAYOUT)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_MATRIX_LAYOUT_ROW_MAJOR)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_MATRIX_LAYOUT_COLUMN_MAJOR)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_MATRIX_LAYOUT_MUL_OPTIMAL)
    ENUM_ITEM(D3D12_LINEAR_ALGEBRA_MATRIX_LAYOUT_OUTER_PRODUCT_OPTIMAL)
ENUM_END(D3D12_LINEAR_ALGEBRA_MATRIX_LAYOUT)

ENUM_BEGIN(D3D12_FENCE_BARRIERS_TIER)
    ENUM_ITEM(D3D12_FENCE_BARRIERS_TIER_NOT_SUPPORTED)
    ENUM_ITEM(D3D12_FENCE_BARRIERS_TIER_1)
    ENUM_ITEM(D3D12_FENCE_BARRIERS_TIER_2)
ENUM_END(D3D12_FENCE_BARRIERS_TIER)
